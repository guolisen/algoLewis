...
1. **912. 排序数组**：英文名为 **Sort an Array**。
2. **215. 数组中的第 K 个最大元素**：英文名为 **Kth Largest Element in an Array**。
3. **剑指 Offer 40. 最小的 k 个数**：无官方英文题目名称，结合题意常用直译为 **The Smallest k Numbers** 。
4. **75. 颜色分类**：英文名为 **Sort Colors**。
