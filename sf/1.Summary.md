...
1. 01背包   **125 · Backpack II**
    i 第i个，j 当前背包大小 ，v 物品体积 w物品重量/价值
...
1. 开放寻址法   
   ...
   a. 如果槽位 `h'(k)` 被占用，就依次检查下一个槽位 `h'(k)+1`, `h'(k)+2`, ...，直到找到空位。

   b. 探查的偏移量不再是线性的，而是以二次方的方式增长。例如，如果 `h'(k)` 冲突，接下来探查 `h'(k)+1`, `h'(k)+4`, `h'(k)+9`, ...
...
![](./assets/2026-01-11_20-31-53.png)
